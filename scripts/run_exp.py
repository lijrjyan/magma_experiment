...
def compose_simulation_config(
    ...
    *,
    ...
    sim_config = {
        ...
        "trimmed_ratio": float(agg_cfg.get("trimmed_ratio", 0.1)),
        "clipping_threshold": float(agg_cfg.get("clipping_threshold", 0.1)),
        "krum_max_expected_adversaries": agg_cfg.get("krum_max_expected_adversaries"),
        "cos_similarity_threshold": agg_cfg.get("cos_similarity_threshold"),
...
def summarize_run(
    ...
    *,
    ...
    summary = {
        ...
        "use_fhe": sim_config.get("use_fhe"),
        "trimmed_ratio": sim_config.get("trimmed_ratio"),
        "clipping_threshold": sim_config.get("clipping_threshold"),
        "krum_max_expected_adversaries": sim_config.get("krum_max_expected_adversaries"),
        "cos_similarity_threshold": sim_config.get("cos_similarity_threshold"),
